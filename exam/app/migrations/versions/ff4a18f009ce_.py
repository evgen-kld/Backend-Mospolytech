...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['books_id'], ['books.id'], name=op.f('fk_books_genres_books_id_books'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['genres_id'], ['genres.id'], name=op.f('fk_books_genres_genres_id_genres'), ondelete='CASCADE'),
